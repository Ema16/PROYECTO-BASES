$(document).ready(function () {
    ...
    $('.search-book-button').click(function (e) {
        e.preventDefault();
        // var LinkSearchBook = "TrabajoGraduacions/BusquedaNormal";
        //var LinkSearchBook=$(this).attr("data-href");
        swal({
            title: "¿Qué Trabajo de Graduacion estás buscando?",
            text: "Por favor escribe el nombre del Trabajo de Graduacion",
            type: "input",
            showCancelButton: true,
            closeOnConfirm: false,
            animation: "slide-from-top",
            ...
            inputPlaceholder: "Escribe aquí el nombre del Trabajo de Graduacion"
        },
            function (inputValue) {
                ...
                var url = "/TrabajoGraduacions/Busqueda?bookName=" + inputValue;
                window.location.href = url;
                // window.location.href = "TrabajoGraduacions/"+LinkSearchBook + "?bookName=" + inputValue;
            });
    });
